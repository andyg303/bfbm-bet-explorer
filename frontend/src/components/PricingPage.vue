...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-[#0b0f1a] text-gray-800 dark:text-gray-200 transition-colors duration-200">
    <!-- Nav -->
    <nav class="sticky top-0 z-50 bg-white/80 dark:bg-[#0b0f1a]/80 backdrop-blur-2xl border-b border-gray-200/80 dark:border-gray-800/40">
          ...
          <div class="h-full glass-card !rounded-2xl" :class="plan.popular ? '!border-teal-500/30' : ''">
            ...
            <div class="p-8">
              ...
              <ul class="mt-6 space-y-3">
                <li v-for="feat in plan.features" :key="feat" class="flex items-start gap-2.5 text-sm text-gray-600 dark:text-gray-400">
