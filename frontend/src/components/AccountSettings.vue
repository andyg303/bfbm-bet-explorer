        ...
        <div class="p-6 space-y-4">
          ...
          <div class="border border-gray-200 dark:border-gray-700/50 rounded-xl overflow-hidden">
            ...
            <div v-if="showCommissionHelp" class="px-4 py-4 space-y-3 text-xs text-gray-500 dark:text-gray-400 bg-gray-50/50 dark:bg-gray-800/10 border-t border-gray-200 dark:border-gray-700/50">
              ...
              <p><strong class="text-gray-700 dark:text-gray-300">The Bets table</strong> shows gross P/L and commission separately so you can see exactly what was deducted. Dashboard totals, strategy tables, graphs, ROI and filters use net P/L after commission.</p>
              <p><strong class="text-gray-700 dark:text-gray-300">Recalculate All Bets</strong> saves your new rates and re-runs commission across all your existing bets. New uploads are calculated automatically.</p>
            </div>
          </div>
