...
<template>
  <div class="min-h-screen flex items-center justify-center bg-[#0b0f1a] px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md animate-fade-in-up">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-white">BFBM<span class="text-teal-400">Explorer</span></h1>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div v-if="mode === 'login' || mode === 'register'">
            ...
            <div class="relative">
              ...
              <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-300">
            ...
            <div v-if="mode === 'register' && password.length > 0" class="mt-2">
              <div class="flex gap-1 mb-1">
                <div v-for="i in 5" :key="i" class="h-1 flex-1 rounded-full transition-colors" :class="i <= passwordStrength.score ? passwordStrength.color : 'bg-gray-800'" />
              </div>
          ...
          <!-- Reset token -->
          <div v-if="mode === 'reset'">
            <label class="block text-sm font-medium text-gray-400 mb-1.5">Reset Token</label>
      ...
      <div class="text-center mt-4">
        <button @click="$emit('navigate', 'landing')" class="text-sm text-gray-600 hover:text-gray-400 transition-colors">← Back to homepage</button>
      </div>

      <p class="text-center text-xs text-gray-700 mt-6">Your data is encrypted and stored securely.</p>
    </div>
  </div>
</template>
